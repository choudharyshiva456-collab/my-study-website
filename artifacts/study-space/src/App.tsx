...
History: [
  ...
  {
    id: 21,
    question: 'Q21. पृथ्वी के संदर्भ में निम्नलिखित कथनों पर विचार कीजिए: 1. पृथ्वी सूर्य से तीसरा ग्रह है। 2. पृथ्वी आंतरिक ग्रहों में सबसे बड़ा है। 3. पृथ्वी पर जीवन के लिए अनुकूल परिस्थितियाँ पाई जाती हैं। सही उत्तर चुनिए:',
    options: ['केवल 1', 'केवल 1 और 2', 'केवल 2 और 3', '1, 2 और 3'],
    answer: 3,
    hint: 'पृथ्वी की स्थिति, आकार और जीवन के लिए अनुकूल परिस्थितियों पर ध्यान दें।'
  },

  {
    id: 22,
    question: 'Q22. निम्नलिखित में से कौन-सा युग्म सही सुमेलित है?',
    options: ['बुध — सबसे बड़ा ग्रह', 'बृहस्पति — आंतरिक ग्रह', 'पृथ्वी — सबसे बड़ा आंतरिक ग्रह', 'नेप्च्यून — सूर्य के सबसे निकट ग्रह'],
    answer: 2,
    hint: 'स्थलीय ग्रहों के आकार की तुलना कीजिए।'
  },

  {
    id: 23,
    question: 'Q23. पृथ्वी पर दिन और रात होने का मुख्य कारण क्या है?',
    options: ['सूर्य के चारों ओर पृथ्वी का परिक्रमण', 'पृथ्वी का अपने अक्ष पर घूर्णन', 'चंद्रमा का पृथ्वी के चारों ओर परिक्रमण', 'सूर्य का अपनी धुरी पर घूमना'],
    answer: 1,
    hint: 'पृथ्वी की दैनिक गति के बारे में सोचिए।'
  },

  {
    id: 24,
    question: 'Q24. यदि पृथ्वी का घूर्णन न हो, तो निम्नलिखित में से कौन-सी घटना सबसे सीधे प्रभावित होगी?',
    options: ['दिन और रात का नियमित चक्र', 'ग्रहों की संख्या', 'क्षुद्रग्रह पट्टी', 'सूर्य की ऊर्जा'],
    answer: 0,
    hint: 'घूर्णन का संबंध पृथ्वी के दैनिक चक्र से है।'
  },

  {
    id: 25,
    question: 'Q25. तारे और ग्रह के बीच सही अंतर कौन-सा है?',
    options: ['ग्रह स्वयं प्रकाश उत्पन्न करते हैं, तारे नहीं।', 'तारे स्वयं प्रकाश देते हैं, जबकि ग्रह सामान्यतः तारों के प्रकाश को परावर्तित करते हैं।', 'सभी ग्रह तारों से बड़े होते हैं।', 'ग्रह केवल दिन में दिखाई देते हैं।'],
    answer: 1,
    hint: 'तारे और ग्रह के प्रकाश के स्रोत पर ध्यान दें।'
  },

  {
    id: 26,
    question: 'Q26. सौरमंडल के संदर्भ में निम्नलिखित में से कौन-सा कथन सही है?',
    options: ['सौरमंडल में केवल सूर्य और आठ ग्रह शामिल हैं।', 'सौरमंडल में सूर्य, ग्रह, उपग्रह तथा अन्य छोटे खगोलीय पिंड भी शामिल हैं।', 'सूर्य पृथ्वी का उपग्रह है।', 'सभी खगोलीय पिंड स्वयं प्रकाश देते हैं।'],
    answer: 1,
    hint: 'सौरमंडल में केवल ग्रह ही नहीं, अन्य खगोलीय पिंड भी शामिल हैं।'
  },

  {
    id: 27,
    question: 'Q27. निम्नलिखित में से कौन-सा समूह आंतरिक/स्थलीय ग्रहों का है?',
    options: ['बुध, शुक्र, पृथ्वी, मंगल', 'पृथ्वी, मंगल, बृहस्पति, शनि', 'बृहस्पति, शनि, यूरेनस, नेप्च्यून', 'बुध, पृथ्वी, शनि, नेप्च्यून'],
    answer: 0,
    hint: 'सूर्य के निकट स्थित चार ग्रह याद कीजिए।'
  },

  {
    id: 28,
    question: 'Q28. पृथ्वी को जीवन के लिए अनुकूल ग्रह बनाने में निम्नलिखित में से कौन-कौन से कारक महत्वपूर्ण हैं? 1. सूर्य से उपयुक्त दूरी 2. तरल जल की उपलब्धता 3. अनुकूल वायुमंडलीय परिस्थितियाँ',
    options: ['केवल 1', 'केवल 1 और 2', 'केवल 2 और 3', '1, 2 और 3'],
    answer: 3,
    hint: 'जीवन के लिए केवल दूरी ही नहीं, कई परिस्थितियाँ आवश्यक हैं।'
  },

  {
    id: 29,
    question: 'Q29. निम्नलिखित में से कौन-सा कथन सही है?',
    options: ['सूर्य एक ग्रह है और पृथ्वी एक तारा।', 'सूर्य सौरमंडल का केंद्र है और पृथ्वी उसका एक ग्रह है।', 'चंद्रमा स्वयं प्रकाश उत्पन्न करता है।', 'पृथ्वी सौरमंडल का सबसे बड़ा ग्रह है।'],
    answer: 1,
    hint: 'सूर्य, पृथ्वी और चंद्रमा की प्रकृति याद कीजिए।'
  },

  {
    ...
    options: ['कथन पूर्णतः सही है; केवल दूरी ही पर्याप्त है।', 'कथन गलत है; दूरी का कोई महत्व नहीं है।', 'दूरी महत्वपूर्ण है, लेकिन जल, वायुमंडल और अन्य अनुकूल परिस्थितियाँ भी आवश्यक हैं।', 'केवल पृथ्वी का आकार जीवन के लिए जिम्मेदार है।'],
    answer: 2,
    hint: 'जीवन के लिए अनेक भौतिक और पर्यावरणीय परिस्थितियों की आवश्यकता होती है।'
  },
],
