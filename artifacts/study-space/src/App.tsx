...
const questionBanks: Record<string, Question[]> = {
  ...
  Geography: [
    ...
    { id: 203, question: 'काली मिट्टी किस फसल के लिए प्रसिद्ध है?', options: ['चाय', 'कपास', 'चावल', 'गेहूँ'], answer: 1, hint: 'It retains moisture and has a deep colour.' },
  ],
  Economy: [
